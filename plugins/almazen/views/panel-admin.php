...
<div class="az-page az-auth">
    ...
    <div class="az-container">
        ...
        <form method="get"
              action="<?php echo esc_url(home_url('/panel-admin')); ?>"
              class="az-form">
            ...
            <div class="az-search">
                ...
                <button
                    type="submit"
                    class="az-btn az-btn-primary az-btn-icon"
                    aria-label="Buscar"
                >
        ...
        <?php elseif ($producto) : ?>
            ...
            <div class="az-form">
                ...
                <?php if (!empty($producto['marca'])) : ?>
                    ...
                    <p class="az-mb-sm">
                        <strong>Marca:</strong>
                        <?php echo esc_html($producto['marca']); ?>
                    </p>
                ...
                <p class="az-mb-sm">
                    ...
                    <?php echo esc_html($producto['cantidad']); ?>
                </p>


                <p class="az-mb-sm">
                    <strong>Unidad:</strong>
                    <?php echo esc_html($producto['unidad']); ?>
                </p>
                ...
                <?php if (!empty($producto['empaque'])) : ?>
                    ...
                    <p class="az-mb-sm">
                        ...
                        <?php echo esc_html($producto['empaque']); ?>
                    </p>
                ...
                <p>
                    ...
                    echo esc_html(
                        date(
                            'd/m/Y H:i',
                            strtotime($producto['fecha_actualizacion'])
                        )
                    );
                    ?>
                </p>
        ...
        <?php if (isset($_GET['q']) || isset($_GET['id'])) : ?>
            ...
            <a
                href="<?php echo esc_url(home_url('/panel-admin')); ?>"
                class="az-btn az-btn-secondary az-mb-md"
            >
                Volver al panel
            </a>
